...
def log_workflow_run(state: Dict[str, Any], db: Session):
    try:
        ...
        if run:
            run.current_step = "coded_draft_claim"
...
def generate_prior_auth(clinical_note: str, procedure: str):
    """Generate a coded draft claim and predict approval likelihood."""
